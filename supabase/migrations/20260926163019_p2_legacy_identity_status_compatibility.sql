...
comment on function private.resolve_message_business_identity_impl(uuid) is
  'Exact-email message identity resolver. Preserves legacy one-message status while requiring deterministic Contact/Company consensus for multi-message conversation propagation.';
