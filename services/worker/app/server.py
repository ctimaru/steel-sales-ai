...
from .company_discovery import (
    install_company_discovery_poller,
    router as company_discovery_router,
)
...
from .source_recovery_bootstrap import install_offer_source_recovery_bootstrap
...
install_company_discovery_poller(app)
...
install_offer_source_recovery_bootstrap(app)
install_offer_source_ambiguous_recovery_bootstrap(app)
